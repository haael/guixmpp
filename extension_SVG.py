...
class extension_SVG(sleekxmpp.plugins.base.base_plugin):
	...
	def make_svg_message(self, mto, msvg, mbody=None):
	...
	def send_svg_message(self, mto, msvg, mbody=None):
		self.make_svg_message(mto, msvg, mbody).send()
	
	def svg_send(self, jid, obj, svg):
